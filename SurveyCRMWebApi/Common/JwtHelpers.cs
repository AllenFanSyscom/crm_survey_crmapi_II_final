...
namespace SurveyCRMWebApiV2.Utility
{
    public class JwtHelpers
    {
        ...
        public string GenerateToken(string key)
        {
            ...
            int expireMinutes = Convert.ToInt32(AppSettingsHelper.JwtSettings.EffectiveTime.ToString());
            var issuer = AppSettingsHelper.JwtSettings.Issuer.ToString();
            var signKey = AppSettingsHelper.JwtSettings.SignKey.ToString();
            ...
            claims.Add(new Claim(JwtRegisteredClaimNames.Sub, key)); // User.Identity.Name
