...
namespace libs.Dapper
{
    ...
    public static partial class SqlMapper
    {
        ...
        private static void ResetTypeHandlers(bool clone)
        {
            ...
            catch { /* https://github.com/libs/dapper-dot-net/issues/424 */ }
...
#pragma warning restore 618
                ...
                if (checkForDuplicates)
                {
                    ...
                    il.EmitCall(OpCodes.Call, typeof(SqlMapper).GetMethod(nameof(FindOrAddParameter)), null); // stack is [parameters] [parameter]
                }
                else
                {
