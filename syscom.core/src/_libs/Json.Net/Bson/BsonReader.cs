...
namespace libs.Json.Bson
{
    /// <summary>
    /// Represents a reader that provides fast, non-cached, forward-only access to serialized BSON data.
    /// </summary>
    [Obsolete("BSON reading and writing has been moved to its own package. See https://www.nuget.org/packages/libs.Json.Bson for more details.")]
    public class BsonReader : JsonReader
    {
        ...
        /// </value>
        [Obsolete("libs35BinaryCompatibility will be removed in a future version of Json.NET.")]
        public bool libs35BinaryCompatibility
        {
