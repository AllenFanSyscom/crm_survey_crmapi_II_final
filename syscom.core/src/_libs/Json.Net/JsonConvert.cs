...
namespace libs.Json
{
    ...
    /// </summary>
    /// <example>
    ///   <code lang="cs" source="..\Src\libs.Json.Tests\Documentation\SerializationTests.cs" region="SerializeObject" title="Serializing and Deserializing JSON with JsonConvert" />
    /// </example>
