...
namespace libs.Json.Linq
{
    ...
    /// </summary>
    /// <example>
    ///   <code lang="cs" source="..\Src\libs.Json.Tests\Documentation\LinqToJsonTests.cs" region="LinqToJsonCreateParse" title="Parsing a JSON Object from Text" />
    /// </example>
...
#endif
    {
        ...
        /// <summary>
        /// Gets the <see cref="libs.Json.Linq.JToken"/> with the specified property name.
        /// </summary>
        /// <param name="propertyName">Name of the property.</param>
        /// <returns>The <see cref="libs.Json.Linq.JToken"/> with the specified property name.</returns>
        ...
        /// <summary>
        /// Tries to get the <see cref="libs.Json.Linq.JToken"/> with the specified property name.
        /// The exact property name will be searched for first and if no matching property is found then
        /// the <see cref="StringComparison"/> will be used to match a property.
        /// </summary>
        /// <param name="propertyName">Name of the property.</param>
