...
namespace libs.Json.Linq
{
...
#endif
    {
        ...
        public virtual T Value<T>(object key)
        {
            ...
            // null check to fix MonoTouch issue - https://github.com/dolbz/libs.Json/commit/a24e3062846b30ee505f3271ac08862bb471b822
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="libs.Json.Linq.JToken"/> to <see cref="System.Boolean"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="libs.Json.Linq.JToken"/> to <see cref="System.DateTimeOffset"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="libs.Json.Linq.JToken"/> to <see cref="System.SByte"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        [CLSCompliant(false)]
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="libs.Json.Linq.JToken"/> to <see cref="System.UInt64"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        [CLSCompliant(false)]
