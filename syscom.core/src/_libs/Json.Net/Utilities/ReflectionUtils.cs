    ...
    internal static class ReflectionUtils
    {
        ...
        public static Attribute[] GetAttributes(object provider, Type attributeType, bool inherit)
        {
            ...
            if (provider is MemberInfo)
            {
                ...
                return (Attribute[]) ((attributeType != null) ? m.GetCustomAttributes(attributeType, inherit).ToArray() : m.GetCustomAttributes(inherit).ToArray());
            }
            ...
            if (provider is ParameterInfo)
            {
                ...
                return (Attribute[]) ((attributeType != null) ? p.GetCustomAttributes(attributeType, inherit).ToArray() : p.GetCustomAttributes(inherit).ToArray());
            }
