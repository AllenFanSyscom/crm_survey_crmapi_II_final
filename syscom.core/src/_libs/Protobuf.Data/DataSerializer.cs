...
namespace libs.ProtoBuf.Data
{
	...
	public static class DataSerializer
	{
		...
		public static void Serialize( Stream stream, IDataReader reader ) { Engine.Serialize( stream, reader ); }
		...
		public static void Serialize( Stream stream, IDataReader reader, ProtoDataWriterOptions options ) { Engine.Serialize( stream, reader, options ); }
		...
		public static void Serialize( Stream stream, DataTable dataTable ) { Engine.Serialize( stream, dataTable ); }
		...
		/// <param name="dataTable">The <see cref="System.Data.DataTable"/> who's contents to serialize.</param>
		/// <param name="options"><see cref="ProtoDataWriterOptions"/> specifying any custom serialization options.</param>
		public static void Serialize( Stream stream, DataTable dataTable, ProtoDataWriterOptions options ) { Engine.Serialize( stream, dataTable, options ); }
		...
		public static void Serialize( Stream stream, DataSet dataSet ) { Engine.Serialize( stream, dataSet ); }
		...
		/// <param name="dataSet">The <see cref="System.Data.DataSet"/> who's contents to serialize.</param>
		/// <param name="options"><see cref="ProtoDataWriterOptions"/> specifying any custom serialization options.</param>
		public static void Serialize( Stream stream, DataSet dataSet, ProtoDataWriterOptions options ) { Engine.Serialize( stream, dataSet, options ); }
		...
		public static IDataReader Deserialize( Stream stream ) { return Engine.Deserialize( stream ); }

		/// <summary>
		/// Deserialize a protocol-buffer binary stream back into a <see cref="System.Data.DataTable"/>.
		/// </summary>
		/// <param name="stream">The <see cref="System.IO.Stream"/> to read from.</param>
		public static DataTable DeserializeDataTable( Stream stream ) { return Engine.DeserializeDataTable( stream ); }
		...
		public static DataSet DeserializeDataSet( Stream stream, IEnumerable<String> tables ) { return Engine.DeserializeDataSet( stream, tables ); }
		...
		public static DataSet DeserializeDataSet( Stream stream, params String[] tables ) { return Engine.DeserializeDataSet( stream, tables ); }
	}
}