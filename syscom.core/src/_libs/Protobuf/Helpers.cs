...
namespace libs.ProtoBuf
{
	...
	internal sealed class Helpers
	{
		...
		[System.Diagnostics.Conditional( "DEBUG" )]
		public static void DebugAssert( Boolean condition, String message )
		{
#if DEBUG
			if ( !condition )
			{
		...
		[System.Diagnostics.Conditional( "DEBUG" )]
		public static void DebugAssert( Boolean condition, String message, params Object[] args )
		{
#if DEBUG
...
#endif
		public static void BlockCopy( Byte[] from, Int32 fromIndex, Byte[] to, Int32 toIndex, Int32 count )
		{
#if MF || WINRT
		...
		public static Boolean IsInfinity( Single value )
		{
#if MF
		...
		internal static Boolean IsSubclassOf( Type type, Type baseClass )
		{
#if WINRT
		...
		internal static Boolean IsValueType( Type type )
		{
#if WINRT
		...
		internal static Boolean IsEnum( Type type )
		{
#if WINRT
		...
		internal static MethodInfo GetGetMethod( PropertyInfo property, Boolean nonPublic, Boolean allowInternal )
		{
		...
		internal static MethodInfo GetSetMethod( PropertyInfo property, Boolean nonPublic, Boolean allowInternal )
		{
			if ( property == null ) return null;
#if WINRT
		...
		internal static ConstructorInfo GetConstructor( Type type, Type[] parameterTypes, Boolean nonPublic )
		{
#if PORTABLE
		...
		internal static ConstructorInfo[] GetConstructors( Type type, Boolean nonPublic )
		{
		...
		internal static PropertyInfo GetProperty( Type type, String name, Boolean nonPublic )
		{
		...
		internal static MemberInfo[] GetInstanceFieldsAndProperties( Type type, Boolean publicOnly )
		{
#if WINRT
		...
		internal static Boolean IsAssignableFrom( Type target, Type type )
		{
#if WINRT
