...
namespace libs.ProtoBuf.Meta
{
	internal abstract class AttributeMap
	{
...
#endif
		public abstract Boolean TryGet( String key, Boolean publicOnly, out Object value );
		public Boolean TryGet( String key, out Object value ) { return TryGet( key, true, out value ); }
		public abstract Type AttributeType { get; }

		public static AttributeMap[] Create( TypeModel model, Type type, Boolean inherit )
		{
#if FEAT_IKVM
			...
			for ( var i = 0; i < all.Length; i++ ) result[i] = new ReflectionAttributeMap( (Attribute) all[i] );
			return result;
#endif
		}

		public static AttributeMap[] Create( TypeModel model, MemberInfo member, Boolean inherit )
		{
#if FEAT_IKVM
		...
		sealed class ReflectionAttributeMap : AttributeMap
		{
			public override Object Target => attribute;

			public override Type AttributeType => attribute.GetType();

			public override Boolean TryGet( String key, Boolean publicOnly, out Object value )
			{
