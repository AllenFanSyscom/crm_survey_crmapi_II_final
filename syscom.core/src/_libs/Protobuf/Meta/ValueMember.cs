...
namespace libs.ProtoBuf.Meta
{
	...
	public class ValueMember
	{
		...
		readonly Type parentType, itemType, defaultType, memberType;
		Object defaultValue;
		...
		/// </summary>
		public ValueMember( RuntimeTypeModel model, Type parentType, Int32 fieldNumber, MemberInfo member, Type memberType, Type itemType, Type defaultType, DataFormat dataFormat, Object defaultValue )
		...
		/// Creates a new ValueMember instance
		/// </summary>
		internal ValueMember( RuntimeTypeModel model, Int32 fieldNumber, Type memberType, Type itemType, Type defaultType, DataFormat dataFormat )
		{
		...
		static Object ParseDefaultValue( Type type, Object value )
		{
			{
			...
			if ( value is String )
			{
				...
				{
					case ProtoTypeCode.Boolean: return Boolean.Parse( s );
					...
					case ProtoTypeCode.Int16:    return Int16.Parse( s, NumberStyles.Any, CultureInfo.InvariantCulture );
					case ProtoTypeCode.Int32:    return Int32.Parse( s, NumberStyles.Any, CultureInfo.InvariantCulture );
					case ProtoTypeCode.Int64:    return Int64.Parse( s, NumberStyles.Any, CultureInfo.InvariantCulture );
					case ProtoTypeCode.SByte:    return SByte.Parse( s, NumberStyles.Integer, CultureInfo.InvariantCulture );
					case ProtoTypeCode.Single:   return Single.Parse( s, NumberStyles.Any, CultureInfo.InvariantCulture );
					case ProtoTypeCode.String:   return s;
					case ProtoTypeCode.UInt16:   return UInt16.Parse( s, NumberStyles.Any, CultureInfo.InvariantCulture );
					case ProtoTypeCode.UInt32:   return UInt32.Parse( s, NumberStyles.Any, CultureInfo.InvariantCulture );
					case ProtoTypeCode.UInt64:   return UInt64.Parse( s, NumberStyles.Any, CultureInfo.InvariantCulture );
		...
		/// </summary>
		public Boolean IsStrict { get => HasFlag( OPTIONS_IsStrict ); set => SetFlag( OPTIONS_IsStrict, value, true ); }

		/// <summary>
		/// Indicates whether this field should use packed encoding (which can save lots of space for repeated primitive values).
		/// This option only applies to list/array data of primitive types (int, double, etc).
		/// </summary>
		public Boolean IsPacked { get => HasFlag( OPTIONS_IsPacked ); set => SetFlag( OPTIONS_IsPacked, value, true ); }

		/// <summary>
		/// Indicates whether this field should *repace* existing values (the default is false, meaning *append*).
		/// This option only applies to list/array data.
		/// </summary>
		public Boolean OverwriteList { get => HasFlag( OPTIONS_OverwriteList ); set => SetFlag( OPTIONS_OverwriteList, value, true ); }

		/// <summary>
		/// Indicates whether this field is mandatory.
		/// </summary>
		public Boolean IsRequired { get => HasFlag( OPTIONS_IsRequired ); set => SetFlag( OPTIONS_IsRequired, value, true ); }
		...
		public void SetSpecified( MethodInfo getSpecified, MethodInfo setSpecified )
		{
			if ( getSpecified != null )
				if ( getSpecified.ReturnType != model.MapType( typeof( Boolean ) )
			...
			if ( setSpecified != null )
			{
				...
				if ( setSpecified.ReturnType != model.MapType( typeof( void ) )
				     ...
				     || args[0].ParameterType != model.MapType( typeof( Boolean ) ) )
		...
		IProtoSerializer BuildSerializer()
		{
			...
			try
			{
				...
				WireType wireType;
				var finalType = itemType == null ? memberType : itemType;
				var ser = TryGetCoreSerializer( model, dataFormat, finalType, out wireType, asReference, dynamicType, OverwriteList, true );
				...
				{
					if ( IsPacked ) throw new NotSupportedException( "Packed encodings cannot support null values" );
				...
				if ( memberType == model.MapType( typeof( Uri ) ) ) ser = new UriDecorator( model, ser );
				if ( member != null )
				{
					...
					if ( getSpecified != null || setSpecified != null ) ser = new MemberSpecifiedDecorator( getSpecified, setSpecified, ser );
				}
		...
		static WireType GetIntWireType( DataFormat format, Int32 width )
		{
			switch ( format )
			{
		...
		(
			RuntimeTypeModel model, DataFormat dataFormat, Type type, out WireType defaultWireType,
			Boolean asReference, Boolean dynamicType, Boolean overwriteList, Boolean allowComplexTypes
		)
		{
#if !NO_GENERICS
			{
			...
			switch ( code )
			{
				...
				case ProtoTypeCode.String:
					...
					if ( asReference ) return new NetObjectSerializer( model, model.MapType( typeof( String ) ), 0, BclHelpers.NetObjectOptions.AsReference );
		...
		/// </summary>
		public String Name => Helpers.IsNullOrEmpty( name ) ? member.Name : name;
		...
		/// </summary>
		public Boolean SupportNull { get => HasFlag( OPTIONS_SupportNull ); set => SetFlag( OPTIONS_SupportNull, value, true ); }

		internal String GetSchemaTypeName( Boolean applyNetObjectProxy, ref Boolean requiresBclImport )
		{
...
#endif
		{
			...
			public Int32 Compare( Object x, Object y ) { return Compare( x as ValueMember, y as ValueMember ); }

			public Int32 Compare( ValueMember x, ValueMember y )
			{
