...
namespace libs.ProtoBuf
{
	internal sealed class NetObjectCache
	{
		...
		internal Object GetKeyedObject( Int32 key )
		{
			if ( key-- == Root )
			{
		...
		internal void SetKeyedObject( Int32 key, Object value )
		{
			if ( key-- == Root )
			{
			...
			else
			{
				...
				if ( key < list.Count )
				{
					...
					if ( oldVal == null )
						list[key] = value;
					else if ( !ReferenceEquals( oldVal, value ) ) throw new ProtoException( "Reference-tracked objects cannot change reference" );
				}
		...
		internal Int32 AddObjectKey( Object value, out Boolean existing )
		{
			if ( value == null ) throw new ArgumentNullException( "value" );
			...
			if ( s == null )
			{
				...
				if ( objectKeys == null )
				{
					objectKeys = new System.Collections.Generic.Dictionary<Object, Int32>( ReferenceComparer.Default );
					index = -1;
				}
				else
				{
			...
			else
			{
				if ( stringKeys == null )
				{
					stringKeys = new System.Collections.Generic.Dictionary<String, Int32>();
					index = -1;
				}
				else
				{
		...
		Int32 trapStartIndex; // defaults to 0 - optimization for RegisterTrappedObject
		...
		System.Collections.Generic.Dictionary<String, Int32> stringKeys;

#if !CF && !PORTABLE // CF lacks the ability to get a robust reference-based hash-code, so we'll do it the harder way instead
		System.Collections.Generic.Dictionary<Object, Int32> objectKeys;
		...
		sealed class ReferenceComparer : System.Collections.Generic.IEqualityComparer<Object>
		{
			...
			Boolean System.Collections.Generic.IEqualityComparer<Object>.Equals( Object x, Object y )
			{
				return x == y; // ref equality
			}

			Int32 System.Collections.Generic.IEqualityComparer<Object>.GetHashCode( Object obj ) { return System.Runtime.CompilerServices.RuntimeHelpers.GetHashCode( obj ); }
		}
#endif
