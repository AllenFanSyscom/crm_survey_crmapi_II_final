...
namespace libs.ProtoBuf
{
	...
	public sealed class ProtoWriter : IDisposable
	{
		...
		public static void WriteObject( Object value, Int32 key, ProtoWriter writer )
		{
#if FEAT_IKVM
            throw new NotSupportedException();
#else
			if ( writer == null ) throw new ArgumentNullException( "writer" );
			if ( writer.model == null ) throw new InvalidOperationException( "Cannot serialize sub-objects unless a model is provided" );
		...
		/// <param name="key">The key that uniquely identifies the type within the model.</param>
		/// <param name="writer">The destination.</param>
		public static void WriteRecursionSafeObject( Object value, Int32 key, ProtoWriter writer )
		{
			if ( writer == null ) throw new ArgumentNullException( "writer" );
			if ( writer.model == null ) throw new InvalidOperationException( "Cannot serialize sub-objects unless a model is provided" );
		...
		internal static void WriteObject( Object value, Int32 key, ProtoWriter writer, PrefixStyle style, Int32 fieldNumber )
		{
#if FEAT_IKVM
            throw new NotSupportedException();
#else
			...
			if ( key < 0 )
			{
				if ( !writer.model.TrySerializeAuxiliaryType( writer, value.GetType(), DataFormat.Default, Serializer.ListItemTag, value, false ) ) TypeModel.ThrowUnexpectedType( value.GetType() );
			}
			else
			{
				writer.model.Serialize( key, value, writer );
		...
		readonly NetObjectCache netCache = new NetObjectCache();
		internal NetObjectCache NetCache => netCache;

		Int32 fieldNumber, flushLock;
		WireType wireType;
		...
		/// </summary>
		public static void WriteFieldHeader( Int32 fieldNumber, WireType wireType, ProtoWriter writer )
		{
			if ( writer == null ) throw new ArgumentNullException( "writer" );
		...
		internal static void WriteHeaderCore( Int32 fieldNumber, WireType wireType, ProtoWriter writer )
		{
			var header = ( (UInt32) fieldNumber << 3 )
			             | ( (UInt32) wireType & 7 );
		...
		/// Writes a byte-array to the stream; supported wire-types: String
		/// </summary>
		public static void WriteBytes( Byte[] data, Int32 offset, Int32 length, ProtoWriter writer )
		{
			if ( data == null ) throw new ArgumentNullException( "data" );
			if ( writer == null ) throw new ArgumentNullException( "writer" );
			switch ( writer.wireType )
			{
				...
				case WireType.Fixed64:
					...
					goto CopyFixedLength; // ugly but effective
				case WireType.String:
					WriteUInt32Variant( (UInt32) length, writer );
		...
		static void CopyRawFromStream( Stream source, ProtoWriter writer )
		{
			var buffer = writer.ioBuffer;
			Int32 space = buffer.Length - writer.ioIndex, bytesRead = 1; // 1 here to spoof case where already full
		...
		static void IncrementedAndReset( Int32 length, ProtoWriter writer )
		{
		...
		Int32 depth = 0;
		const Int32 RecursionCheckDepth = 25;
		...
		public static SubItemToken StartSubItem( Object instance, ProtoWriter writer ) { return StartSubItem( instance, writer, false ); }
		...
		void CheckRecursionStackAndPush( Object instance )
		{
			...
			else if ( instance != null && ( hitLevel = recursionStack.IndexOfReference( instance ) ) >= 0 )
			{
				...
				foreach ( var obj in recursionStack ) Helpers.DebugWriteLine( obj == null ? "<null>" : obj.ToString() );
		...
		void PopRecursionStack() { recursionStack.RemoveLast(); }

		static SubItemToken StartSubItem( Object instance, ProtoWriter writer, Boolean allowFixed )
		{
			if ( writer == null ) throw new ArgumentNullException( "writer" );
			if ( ++writer.depth > RecursionCheckDepth ) writer.CheckRecursionStackAndPush( instance );
			...
			switch ( writer.wireType )
			{
				...
				case WireType.String:
#if DEBUG
					if ( writer.model != null && writer.model.ForwardsOnly ) throw new ProtoException( "Should not be buffering data" );
#endif
					writer.wireType = WireType.None;
				...
				case WireType.Fixed32:
				{
					...
					DemandSpace( 32, writer ); // make some space in anticipation...
					writer.flushLock++;
					var token = new SubItemToken( writer.ioIndex );
		...
		/// <param name="writer">The destination.</param>
		public static void EndSubItem( SubItemToken token, ProtoWriter writer ) { EndSubItem( token, writer, PrefixStyle.Base128 ); }

		static void EndSubItem( SubItemToken token, ProtoWriter writer, PrefixStyle style )
		{
			if ( writer == null ) throw new ArgumentNullException( "writer" );
			if ( writer.wireType != WireType.None ) throw CreateException( writer );
			var value = token.value;
			if ( writer.depth <= 0 ) throw CreateException( writer );
			if ( writer.depth-- > RecursionCheckDepth ) writer.PopRecursionStack();
			...
			{
				case PrefixStyle.Fixed32:
					len = (Int32) ( writer.ioIndex - value - 4 );
				...
				case PrefixStyle.Base128:
					...
					len = (Int32) ( writer.ioIndex - value - 1 );
					var offset = 0;
					var tmp = (UInt32) len;
			...
			const Int32 ADVISORY_FLUSH_SIZE = 1024;
			if ( --writer.flushLock == 0 && writer.ioIndex >= ADVISORY_FLUSH_SIZE ) Flush( writer );
		}
		...
		internal static Int32 GetPosition( ProtoWriter writer ) { return writer.position; }
		Int32 position;

		static void DemandSpace( Int32 required, ProtoWriter writer )
		{
		...
		/// </summary>
		static void WriteUInt32Variant( UInt32 value, ProtoWriter writer )
		{
		...
		internal static UInt32 Zig( Int32 value ) { return (UInt32) ( ( value << 1 ) ^ ( value >> 31 ) ); }
		internal static UInt64 Zig( Int64 value ) { return (UInt64) ( ( value << 1 ) ^ ( value >> 63 ) ); }

		static void WriteUInt64Variant( UInt64 value, ProtoWriter writer )
		{
		...
		public static void WriteString( String value, ProtoWriter writer )
		{
			...
			WriteUInt32Variant( (UInt32) predicted, writer );
			DemandSpace( predicted, writer );
			var actual = encoding.GetBytes( value, 0, value.Length, writer.ioBuffer, writer.ioIndex );
		...
		/// </summary>
		public static void WriteUInt64( UInt64 value, ProtoWriter writer )
		{
			if ( writer == null ) throw new ArgumentNullException( "writer" );
			switch ( writer.wireType )
			{
				...
				case WireType.Variant:
					...
					return;
				case WireType.Fixed32:
					checked { WriteUInt32( (UInt32) value, writer ); }
		...
		/// </summary>
		public static void WriteInt64( Int64 value, ProtoWriter writer )
		{
			Byte[] buffer;
			Int32 index;
			if ( writer == null ) throw new ArgumentNullException( "writer" );
			switch ( writer.wireType )
			{
				...
				case WireType.Variant:
					if ( value >= 0 )
					{
						WriteUInt64Variant( (UInt64) value, writer );
						writer.wireType = WireType.None;
					}
					else
					{
						...
						buffer[index + 1] = (Byte) ( (Int32) ( value >> 7 ) | 0x80 );
						buffer[index + 2] = (Byte) ( (Int32) ( value >> 14 ) | 0x80 );
						buffer[index + 3] = (Byte) ( (Int32) ( value >> 21 ) | 0x80 );
						buffer[index + 4] = (Byte) ( (Int32) ( value >> 28 ) | 0x80 );
						buffer[index + 5] = (Byte) ( (Int32) ( value >> 35 ) | 0x80 );
						buffer[index + 6] = (Byte) ( (Int32) ( value >> 42 ) | 0x80 );
						buffer[index + 7] = (Byte) ( (Int32) ( value >> 49 ) | 0x80 );
						buffer[index + 8] = (Byte) ( (Int32) ( value >> 56 ) | 0x80 );
					...
					return;
				case WireType.Fixed32:
					checked { WriteInt32( (Int32) value, writer ); }
		...
		/// </summary>
		public static void WriteInt16( Int16 value, ProtoWriter writer ) { WriteInt32( value, writer ); }

		/// <summary>
		/// Writes an unsigned 16-bit integer to the stream; supported wire-types: Variant, Fixed32, Fixed64
		/// </summary>
		public static void WriteUInt16( UInt16 value, ProtoWriter writer ) { WriteUInt32( value, writer ); }

		/// <summary>
		/// Writes an unsigned 8-bit integer to the stream; supported wire-types: Variant, Fixed32, Fixed64
		/// </summary>
		public static void WriteByte( Byte value, ProtoWriter writer ) { WriteUInt32( value, writer ); }

		/// <summary>
		/// Writes a signed 8-bit integer to the stream; supported wire-types: Variant, Fixed32, Fixed64, SignedVariant
		/// </summary>
		public static void WriteSByte( SByte value, ProtoWriter writer ) { WriteInt32( value, writer ); }

		static void WriteInt32ToBuffer( Int32 value, Byte[] buffer, Int32 index )
		{
			buffer[index] = (Byte) value;
			buffer[index + 1] = (Byte) ( value >> 8 );
			buffer[index + 2] = (Byte) ( value >> 16 );
		...
		/// </summary>
		public static void WriteInt32( Int32 value, ProtoWriter writer )
		{
			Byte[] buffer;
			Int32 index;
			if ( writer == null ) throw new ArgumentNullException( "writer" );
			switch ( writer.wireType )
			{
				...
				case WireType.Variant:
					if ( value >= 0 )
					{
						WriteUInt32Variant( (UInt32) value, writer );
						writer.wireType = WireType.None;
					}
					else
					{
		...
		public
			...
			unsafe
#endif
			static void WriteSingle( Single value, ProtoWriter writer )
		{
			if ( writer == null ) throw new ArgumentNullException( "writer" );
			switch ( writer.wireType )
			{
		...
		{
			if ( writer == null ) throw new ArgumentNullException( "writer" );
			var rhs = enumValue == null ? "<null>" : enumValue.GetType().FullName + "." + enumValue.ToString();
		...
		/// </summary>
		public static void WriteBoolean( Boolean value, ProtoWriter writer ) { WriteUInt32( value ? (UInt32) 1 : (UInt32) 0, writer ); }
		...
		/// </summary>
		public static void SetPackedField( Int32 fieldNumber, ProtoWriter writer )
		{
			if ( fieldNumber <= 0 ) throw new ArgumentOutOfRangeException( "fieldNumber" );
			if ( writer == null ) throw new ArgumentNullException( "writer" );
		...
		internal String SerializeType( Type type ) { return TypeModel.SerializeType( model, type ); }
