...
namespace libs.ProtoBuf
{
		...
		class Serializer
	{
		...
		public static String GetProto<T>() { return RuntimeTypeModel.Default.GetSchema( RuntimeTypeModel.Default.MapType( typeof( T ) ) ); }

		/// <summary>
		/// Create a deep clone of the supplied instance; any sub-items are also cloned.
		/// </summary>
		public static T DeepClone<T>( T instance ) { return instance == null ? instance : (T) RuntimeTypeModel.Default.DeepClone( instance ); }
		...
		public static T Merge<T>( Stream source, T instance ) { return (T) RuntimeTypeModel.Default.Deserialize( source, instance, typeof( T ) ); }
		...
		public static T Deserialize<T>( Stream source ) { return (T) RuntimeTypeModel.Default.Deserialize( source, null, typeof( T ) ); }
		...
		{
			if ( instance != null ) RuntimeTypeModel.Default.Serialize( destination, instance );
		}
		...
		public static void Serialize<T>( System.Xml.XmlWriter writer, T instance ) where T : System.Xml.Serialization.IXmlSerializable
		{
			...
			using ( var ms = new MemoryStream() )
			{
				...
				writer.WriteBase64( ms.GetBuffer(), 0, (Int32) ms.Length );
			}
		}
		...
		public static void Merge<T>( System.Xml.XmlReader reader, T instance ) where T : System.Xml.Serialization.IXmlSerializable
		{
			...
			using ( var ms = new MemoryStream() )
			{
				...
				while ( reader.Read() && reader.Depth > depth )
					...
					{
						while ( ( read = reader.ReadContentAsBase64( buffer, 0, LEN ) ) > 0 ) ms.Write( buffer, 0, read );
		...
		const String ProtoBinaryField = "proto";
		...
		public static IEnumerable<T> DeserializeItems<T>( Stream source, PrefixStyle style, Int32 fieldNumber ) { return RuntimeTypeModel.Default.DeserializeItems<T>( source, style, fieldNumber ); }
		...
		/// <returns>A new, initialized instance.</returns>
		public static T DeserializeWithLengthPrefix<T>( Stream source, PrefixStyle style ) { return DeserializeWithLengthPrefix<T>( source, style, 0 ); }
		...
		/// <returns>A new, initialized instance.</returns>
		public static T DeserializeWithLengthPrefix<T>( Stream source, PrefixStyle style, Int32 fieldNumber )
		{
		...
		/// <param name="style">How to encode the length prefix.</param>
		/// <param name="destination">The destination stream to write to.</param>
		public static void SerializeWithLengthPrefix<T>( Stream destination, T instance, PrefixStyle style ) { SerializeWithLengthPrefix<T>( destination, instance, style, 0 ); }
		...
		public static void SerializeWithLengthPrefix<T>( Stream destination, T instance, PrefixStyle style, Int32 fieldNumber )
		{
			var model = RuntimeTypeModel.Default;
		...
		public static Boolean TryReadLengthPrefix( Stream source, PrefixStyle style, out Int32 length )
		{
			Int32 fieldNumber, bytesRead;
		...
		/// <param name="length">The length of the message, if it could be identified.</param>
		/// <returns>True if a length could be obtained, false otherwise.</returns>
		public static Boolean TryReadLengthPrefix( Byte[] buffer, Int32 index, Int32 count, PrefixStyle style, out Int32 length )
		{
		...
		/// </summary>
		public const Int32 ListItemTag = 1;
    ...
    sealed
			...
			class NonGeneric
		{
			...
			/// Create a deep clone of the supplied instance; any sub-items are also cloned.
			/// </summary>
			public static Object DeepClone( Object instance ) { return instance == null ? null : RuntimeTypeModel.Default.DeepClone( instance ); }
			...
			{
				if ( instance != null ) RuntimeTypeModel.Default.Serialize( dest, instance );
			}
			...
			/// <param name="source">The binary stream to apply to the new instance (cannot be null).</param>
			/// <returns>A new, initialized instance.</returns>
			public static Object Deserialize( Type type, Stream source ) { return RuntimeTypeModel.Default.Deserialize( source, null, type ); }
			...
			/// <param name="destination">The destination stream to write to.</param>
			/// <param name="fieldNumber">The tag used as a prefix to each record (only used with base-128 style prefixes).</param>
			public static void SerializeWithLengthPrefix( Stream destination, Object instance, PrefixStyle style, Int32 fieldNumber )
			{
				if ( instance == null ) throw new ArgumentNullException( "instance" );
				var model = RuntimeTypeModel.Default;
			...
			/// either the original instance was null, or the stream defines a known sub-type of the
			/// original instance.</returns>
			public static Boolean TryDeserializeWithLengthPrefix( Stream source, PrefixStyle style, TypeResolver resolver, out Object value )
			{
			...
			/// </summary>
			public static Boolean CanSerialize( Type type ) { return RuntimeTypeModel.Default.IsDefined( type ); }
		}
    ...
    sealed
			...
			class GlobalOptions
		{
			...
			public static Boolean InferTagFromName { get => RuntimeTypeModel.Default.InferTagFromNameDefault; set => RuntimeTypeModel.Default.InferTagFromNameDefault = value; }
		}
#endif
		/// <summary>
		/// Maps a field-number to a type
		/// </summary>
		public delegate Type TypeResolver( Int32 fieldNumber );
