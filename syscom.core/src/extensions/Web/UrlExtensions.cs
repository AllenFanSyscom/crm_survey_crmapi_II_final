...
namespace System.Web
{
	...
	{
		/// <summary>Creates a new Url object from the string and appends a segment to the URL path, ensuring there is one and only one '/' character as a separator</summary>
		...
		public static Url AppendPathSegment( this String url, Object segment, Boolean fullyEncode = false )
		{
		...
		/// <summary>Removes the entire path component of the URL</summary>
		/// <param name="url">This URL.</param>
		/// <returns>A new Flurl.Url object.</returns>
		...
		/// <summary>Creates a new Url object from the string and adds a parameter to the query, overwriting the value if name exists</summary>
		/// <param name="url">This URL.</param>
		...
		/// <param name="nullValueHandling">Indicates how to handle null values. Defaults to Remove (any existing).</param>
		/// <returns>A new Flurl.Url object.</returns>
		public static Url SetQueryParam( this String url, String name, String value, Boolean isEncoded = false, NullValueHandling nullValueHandling = NullValueHandling.Remove )
		{
			return new Url( url ).SetQueryParam( name, value, isEncoded, nullValueHandling );
		}

		/// <summary>Creates a new Url object from the string and adds a parameter without a value to the query, removing any existing value</summary>
		/// <param name="url">This URL.</param>
		/// <param name="name">Name of query parameter</param>
		/// <returns>A new Flurl.Url object.</returns>
		...
		/// <summary>Creates a new Url object from the string, parses values object into name/value pairs, and adds them to the query, overwriting any that already exist</summary>
		/// <param name="url">This URL.</param>
		...
		/// <summary>Creates a new Url object from the string and adds multiple parameters without values to the query</summary>
		/// <param name="url">This URL.</param>
		...
		/// <summary>Creates a new Url object from the string and removes a name/value pair from the query by name</summary>
		/// <param name="url">This URL.</param>
		...
		/// <summary>Creates a new Url object from the string and removes multiple name/value pairs from the query by name</summary>
		/// <param name="url">This URL.</param>
		...
		/// <summary>Trims the URL to its root, including the scheme, any user info, host, and port (if specified).</summary>
		/// <param name="url">This URL.</param>
		/// <returns>A new Flurl.Url object.</returns>
		...
		/// <param name="fullyEncode">If true, URL-encodes reserved characters such as '/', '+', and '%'. Otherwise, only encodes strictly illegal characters (including '%' but only when not followed by 2 hex characters).</param>
		/// <returns>A new Flurl.Url object.</returns>
		public static Url AppendPathSegment( this Uri uri, Object segment, Boolean fullyEncode = false )
		{
		...
		/// <param name="nullValueHandling">Indicates how to handle null values. Defaults to Remove (any existing).</param>
		/// <returns>A new Flurl.Url object.</returns>
		public static Url SetQueryParam( this Uri uri, String name, String value, Boolean isEncoded = false, NullValueHandling nullValueHandling = NullValueHandling.Remove )
		{
